...
function setup() {
	...
	// link to main menu
	panel_link_to_menu = new Panel(x=550, y=-271, w=200, h=40, col=color(137, 9, 45), textSize=20, textCol=color(255), textFont=fontQuivira, textLeading=30, textMargin=25, textAlign=LEFT, interactive=true);	
...
function draw() {
	...
	// link to main menu
	panel_link_to_menu.show("go back to main menu", mode = "link_to_menu");
